                  ...
                  <ul className="space-y-1">
                    {cam.ip && (
                      <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 text-xs text-gray-800 border border-gray-200">
                        <span className="font-cairo font-normal">{cam.ip}</span>
                      </li>
                    )}
                    {cam.mac && (
                      <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 text-xs text-gray-800 border border-gray-200">
                    ...
                    {active && cam.id && (
                      <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-1 border border-gray-200">
                        <Button
                          variant="outline"
                          size="sm"
