  ...
  return (
    <div className="fixed top-0 left-0 z-40 w-[12vw]">
      <aside
        ...
        className="fixed top-0 left-0 z-40 w-[12vw] h-[98vh] -mt-1 transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 rounded-xl m-2 mt-3 mr-1">
          ...
          <ul className="space-y-2 font-normal text-xs">
            <li>
              <button
                type="button"
                className="flex items-center w-full p-2 text-sm text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
