        ...
        <Html distanceFactor={60} position={[2, 0, 0]} center>
          ...
          >
            <div className="bg-white/50 backdrop-blur-sm shadow-xl rounded-xl p-4 text-xs text-gray-800 w-64 border border-gray-200">
              <h3 className="flex items-center justify-center font-cairo text-sm font-bold mb-2 text-black">
                {ac.title || "Camera #1"}
              </h3>
              <ul className="space-y-1">
                ...
                {ac.vendor && (
                  <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 text-xs text-gray-800 border border-gray-200">
                    <span className="font-cairo font-normal">{ac.vendor}</span>
                  </li>
                )}
                {ac.model && (
                  <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 text-xs text-gray-800 border border-gray-200">
                    <span className="font-cairo font-normal">{ac.model}</span>
                  </li>
                )}

                {ac.notes && (
                  <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 text-xs text-gray-800 border border-gray-200">
                    <span className="font-cairo font-normal">{ac.notes}</span>
                  </li>
                )}
                {
                  <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 text-xs text-gray-800 border border-gray-200">
                ...
                <li className="flex items-center justify-center space-y-2 backdrop-blur-sm shadow-xl rounded-md p-2 border border-gray-200 bg-neutral-700">
